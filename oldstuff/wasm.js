...
function callRuntimeCallbacks(callbacks) {
  while (callbacks.length > 0) {
    ...
    if (typeof func === "number") {if (callback.arg === undefined) {getWasmTableEntry(func)()} else {getWasmTableEntry(func)(callback.arg)}} else {
...
var _calc_stuff = Module["_calc_stuff"] = function () {
  return (_calc_stuff = Module["_calc_stuff"] = Module["asm"]["c"]).apply(null, arguments)
};
var calledRun;
