...
define([
  ...
  exports.FBO = class FBO {
    ...
    */
    ...
    create(gl) {
      ...
      this.texDepth = new exports.Texture(gl.createTexture(), gl);
      this.texColor = new exports.Texture(gl.createTexture(), gl);
  ...
  exports.init_webgl = function init_webgl(canvas, params, webgl2) {
