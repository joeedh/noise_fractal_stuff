...
type ThemeValue = string | number | boolean | undefined | CSSFont
type ThemeEntry = {[k: string]: ThemeValue | {[k: string]: ThemeValue}}

export var theme: {[k: string]: ThemeEntry} = {
  base:  {
  ...
  dropbox:  {
    ...
    'border-radius': 155.30666666666667,
    'border-width' : 1,
    dropTextBG     : 'rgba(237,237,237, 1)',
    height         : 24,
    'margin-bottom': 2,
    'margin-left'  : 13.120013020833333,
    'margin-top'   : 0,
    padding        : 0,
    width          : 32,
  },
